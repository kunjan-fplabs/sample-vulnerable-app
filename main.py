...
def deserialize_blob(blob):
    ...
    # Note: ast.literal_eval() only evaluates Python literal structures (strings, numbers, tuples, lists, dicts, booleans, None)
    # If complex object deserialization is required, use JSON or implement strict validation
    try:
